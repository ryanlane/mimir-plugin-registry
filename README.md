...
- [Art Institute of Chicago](https://github.com/ryanlane/mimir-source-Art-Institute-of-Chicago) — Displays artworks from the Art Institute of Chicago's open collection. Browse by department, keyword search, or highlights gallery — no API key required. Supports multiple user-defined galleries as sub-channels.
